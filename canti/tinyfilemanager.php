    ...
    <div class="path">
        <div class="row">
            ...
            <div class="edit-file-actions col-xs-12 col-sm-7 col-lg-6 text-right pt-1">
                <a title="Home" class="btn btn-sm btn-outline-primary" href="?p="><i class="fa fa-home"></i> <?php echo lng('Home') ?></a>
                ...
                <tr>
                    ...
                    <td class="inline-actions">
                        ...
                        <?php if (!FM_READONLY): ?>
                            ...
                            <a title="<?php echo lng('Rename') ?>" href="#" onclick="rename('<?php echo fm_enc(FM_PATH) ?>', '<?php echo fm_enc(addslashes($f)) ?>');return false;"><i class="fa fa-tag"></i></a>
                        ...
                        <a title="<?php echo lng('Download') ?>" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;dl=<?php echo urlencode($f) ?>"><i class="fa fa-download"></i></a>
                            <a title="<?php echo lng('Edit') ?>" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;edit=<?php echo urlencode($f) ?>"><i class="fa fa-pencil-square-o"></i></a>
                    </td>
                </tr>
                <?php
                flush();
